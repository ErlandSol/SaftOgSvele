function TextStyle(_color = c_white, _outline = false, _shadow = false, _font = fontConnectQuest2, _scale = 1, _outlineColor = c_black,_shadowColor = c_black, _outlineOpacity = 1, _shadowOpacity = 1) constructor {
